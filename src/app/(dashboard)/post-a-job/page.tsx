    ...
    <div>
      ...
      <Form {...form}>
        ...
        >
          ...
          <FieldInput
            title="Salary"
            subtitle="Please specify the eslimated salary range for the role"
          >
            <div className="w-[450px] flex flex-row justify-between items-center">
              ...
              />
              <span className="text-center text-gray-400">to</span>
              <FormField
                control={form.control}
                name="salaryTo"
                render={({ field }) => (
          ...
          <FieldInput
            ...
            subtitle="Job title must be describe one"
          >
            <CKEditor
              form={form}
              name="jobDescription"
          ...
          <FieldInput
            ...
            subtitle="Outline your responsibilities of the position"
          >
            <CKEditor
              form={form}
              name="responsibility"
          ...
          <FieldInput
            ...
            subtitle="Encorage more people to apply by sharing the attrative reward and benefits you offer your employees"
          >
